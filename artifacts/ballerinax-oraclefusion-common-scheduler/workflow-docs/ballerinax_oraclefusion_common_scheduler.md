...
![Connector palette open in WSO2 Integrator before selecting a connector](../screenshots/ballerinax_oraclefusion_common_scheduler_screenshot_01_palette.png)
...
![Scheduler connection form with the config record and service URL bound to configurable variables](../screenshots/ballerinax_oraclefusion_common_scheduler_screenshot_02_connection_form.png)

### Step 4: Save the connection

Select **Save Connection** and verify that the connection appears in the **Connections** section.

![Saved schedulerClient connection shown in the project tree and on the design canvas](../screenshots/ballerinax_oraclefusion_common_scheduler_screenshot_03_connections_list.png)
...
![schedulerClient connection expanded to show its scheduler operations before selection](../screenshots/ballerinax_oraclefusion_common_scheduler_screenshot_04_operations_panel.png)
...
![Query Job Requests operation form with the filter and sort order entered](../screenshots/ballerinax_oraclefusion_common_scheduler_screenshot_05_operation_form.png)
...
![Completed automation flow from Start through the scheduler operation and log step to the error handler](../screenshots/ballerinax_oraclefusion_common_scheduler_screenshot_06_completed_flow.png)
